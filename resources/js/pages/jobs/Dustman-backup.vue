                ...
                <div class="tab-pane fade show active" id="work" role="tabpanel">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p>The current trash points price is:<span>0.1 MQ</span></p>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                 <tr>
                                     ...
                                     <td>John</td>
                                     <td>John</td>
                                     <td><span class="garge-action">THROW</span></td>
                                 </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="tab-pane fade" id="accounts" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p>Welcome to the Account Office.</p>
                            <p>This is where you have to your shop accounting....</p>
                            <p>Amount Available In Your Cashier<span>1245.49 MQ</span></p>
                             <div>
                            <table class="table">
                                <thead class="table-color">
                                <tr>
                ...
                <div class="tab-pane fade" id="supplies" role="tabpanel">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <p>This is Where you will receive the supplies to sell in your shop from your manager.</p>
                          <div>
                              <h3>Items Requests</h3>
                        <form id="restaurant-produce-form">
                            <div class="card-body form-row">
                                <div class="col-4">
                                    <select class="form-control inputDropdown"  name="quantity">
                                        <option value="" disabled selected hidden>--list of product--</option>
                                ...
                                <div class="col">
                                    <button type="button" class="genric-btn primary medium">Create</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div>
                        <h3>Your Pst Requests</h3>
                            <table class="table">
                                <thead class="table-color">
                                <tr>
                                    <th>Data</th>
