        ...
        <div class="container-fluid p-0" v-if="is_doer">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="work" role="tabpanel">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4>Components of your Factory</h4>
                            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" id="send-product-form" class="col-6" @submit="sendProduct()" v-on:submit.prevent>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="factory_id" v-model="farmer.id">
    ...
    export default {
        ...
        async mounted() {
            ...
            if (this.$route.params.farmer === undefined) {
                this.is_doer = true;
                const {data} = await axios.post('/ajax/getFactoryJobDetails', {
                ...
                setInterval(function () {
                    ...
                    for (let index in self.current_production) {
                        if (self.current_production[index].complete_in > 0) {
                            ...
                            axios.post('/ajax/completeProductionFactory', {
                ...
                this.is_doer = false;
                const {data} = await axios.post('/ajax/getFactoryJobDetailsForVisitor', {
                    job_id: this.$route.params.id,
        ...
        methods: {
            startProduction() {
                ...
                axios.post('/ajax/startProductionFactory', data)
                    .then(res => {
                        let data = res.data;
                        this.current_production = data.current_production
                        this.farmer_animals = data.farmer_animals
            ...
            sendProduct(event) {
             ...
             console.log("dataaaa",data);
                axios.post('/ajax/FactorySendProduct', data)
                    .then(res => {
            ...
            buyAnimal(id) {
                axios.post('/ajax/buyFactoryAnimal', {id: id, qty: this.purchase_quantity, farmer: this.farmer.id})
                    .then(res => {
                        let data = res.data;
                        this.farmer_animals = data.farmer_animals
